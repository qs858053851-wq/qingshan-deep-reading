...
CATEGORY_RULES = [
    ("哲学与思想", ("哲学", "思想", "庄子", "道德", "自由", "存在", "尼采", "黑格尔", "康德", "柏拉图", "福柯", "批判")),
    ("历史与文明", ("史", "帝国", "战争", "文明", "王朝", "中国", "欧洲", "亚洲", "中东", "罗马", "民国", "明朝", "宋", "唐", "蒙古")),
    ("文学与故事", ("小说", "诗", "词", "三体", "红楼", "三国", "悲惨世界", "局外人", "夫人", "故事", "文集", "神话")),
    ("社会与政治", ("社会", "政治", "国家", "制度", "民主", "权力", "秩序", "贫穷", "人类", "经济", "资本")),
    ("心理与自我", ("心理", "精神分析", "心灵", "关系", "爱", "情绪", "思考", "习惯", "睡觉", "大脑", "冥想")),
    ("宗教与修行", ("宗教", "佛", "禅", "经", "瑜伽", "犹太", "基督", "伊斯兰", "灵性", "修行")),
    ("科学与方法", ("科学", "物理", "数学", "微积分", "系统", "技术", "方法", "逻辑", "百科", "摄影")),
    ("商业与决策", ("投资", "交易", "经济学", "商业", "财富", "管理", "价格", "反脆弱")),
]
